...
Of course expertise knowledge of the dataset and the wine domain is essential to derive valuable insights from the results. With the SOM results we propose promoting "fresh & flavorable wines" as well as "Salty but long-lasting sweet wines". 
...
The wine dealer could further cluster his wine collection according to the Self-Organising Maps (SOM). Following wine segments could be created: "Fresh and favorable" wines corresponding to wines with strong citric acid and density characteristics (corresponds to blue SOM cluster). "Intense and soothing" for wines with high pH and alcohol levels (corresponds to green SOM cluster). "Rich and long-lasting wines" for wines with partially strong characteristics for fixed acidity, residual sugar, chlorides and sulphates (corresponds to orange SOM cluster).
