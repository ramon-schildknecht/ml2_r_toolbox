...
```{r}
### the following code must be adapted to our dataset, actual working for iris dataset ###
...
data <-
  as.matrix(scale(df_unique[, 1:4]))  # scale: mean = 0, sd = 1
...
plot(  # show datapoints, species and number of row
  som_model,
  type = "mapping",
