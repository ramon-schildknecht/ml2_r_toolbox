...
Therefore, he has a database in which the quality of the wines, but also other characteristics are stored. These include, for example, the pH value, acidity, alcohol content, density, etc. A total of 11 predictors are included. We like to get insights especially for red wine. <br>
...
library(kohonen)
library(plot3D)
library(factoextra)  # more complexe library than standard R library; all methods 
                     # for distance & linkage available
library(dendextend)
library(ape)
